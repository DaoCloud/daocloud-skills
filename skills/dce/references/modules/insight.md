...
### `dce insight alert add-group-rule`
...
### `dce insight alert delete-group-rule`
...
### `dce insight alert delete-inhibition`
...
### `dce insight alert delete-provider`
...
### `dce insight alert delete-rule-template`
...
### `dce insight alert delete-silence`
...
### `dce insight alert delete-template`
...
### `dce insight featuregate get-feature-gate-by-id`
...
### `dce insight metric batch-query-metric`
...
### `dce insight resource get-agent-summary`
...
### `dce insight resource get-statefulset`
...
### `dce insight servicegraph get-graph`
