...
func Mount(root *cobra.Command) error {
	...
	return runtime.Build(root, "global-management", Specs)
}
...
func MountFlat(root *cobra.Command) error {
	...
	return runtime.BuildFlat(root, "global-management", Specs)
}
...
var Specs = []runtime.CommandSpec{
	...
	},
	{
		...
		Example:     "dce global-management group create-group \\\n  --set name=dev-team \\\n  --set description=\"Development team\"\n",
	...
	},
	{
		...
		Example:     "dce global-management group update-group --id <id> \\\n  --set name=dev-team-renamed \\\n  --set description=\"Renamed team\"\n",
	...
	},
	{
		...
		Example:     "dce global-management users create-user \\\n  --set name=alice \\\n  --set password=changeme \\\n  --set description=\"Alice from dev team\" \\\n  --set temporary=false\n",
	...
	},
	{
		...
		Example:     "dce global-management users create-user-access-token --id <id> \\\n  --set name=my-token \\\n  --set expiredAt=2026-12-31T00:00:00Z\n",
	...
	},
	{
		...
		Example:     "dce global-management users set-user-password --id <id> \\\n  --set password=NewP@ssw0rd\n",
	...
	},
	{
		...
		Example:     "dce global-management users update-user --id <id> \\\n  --set email=newemail@example.com \\\n  --set firstname=Alice \\\n  --set lastname=Smith \\\n  --set description=\"updated\" \\\n  --set enabled=true\n",
	...
	},
	{
		...
		Example:     "dce global-management workspace authorize --folder-id <folderId> \\\n  --set memberId=<userId> \\\n  --set memberType=user \\\n  --set memberName=alice \\\n  --set-str 'roleNames[0]=Workspace Admin'\n",
	...
	},
	{
		...
		Example:     "dce global-management workspace list-workspaces\ndce global-management workspace list-workspaces -o json\n",
	...
	},
	{
		...
		Example:     "dce global-management workspace update-folder --folder-id <id> \\\n  --set alias=new-folder-name\n",
