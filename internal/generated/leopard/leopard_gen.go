...
func Mount(root *cobra.Command) error {
	...
	return runtime.Build(root, "billing-center", Specs)
}
...
var Specs = []runtime.CommandSpec{
	...
	},
	{
		...
		RequestBody: &runtime.RequestBody{
			Required: true,
			Schema:   &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"end": &runtime.SchemaSpec{Type: "string"}, "filter": &runtime.SchemaSpec{Type: "object", AdditionalProperties: &runtime.AdditionalPropertiesSpec{Schema: &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"values": &runtime.SchemaSpec{Type: "array", Items: &runtime.SchemaSpec{Type: "string"}}}}}}, "filterByAnd": &runtime.SchemaSpec{Type: "boolean"}, "page": &runtime.SchemaSpec{Type: "integer", Format: "int32"}, "pageSize": &runtime.SchemaSpec{Type: "integer", Format: "int32"}, "productName": &runtime.SchemaSpec{Type: "array", Items: &runtime.SchemaSpec{Type: "string"}}, "skuId": &runtime.SchemaSpec{Type: "array", Items: &runtime.SchemaSpec{Type: "string"}}, "start": &runtime.SchemaSpec{Type: "string"}, "userId": &runtime.SchemaSpec{Type: "array", Items: &runtime.SchemaSpec{Type: "string"}}}},
		},
